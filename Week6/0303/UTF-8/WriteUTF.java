...
public class WriteUTF{
   public static void main(String[] args) throws IOException   {
      String names[] = { "Warren", "Becky", "Holly", "Zach", "Chloe", "Можам да јадам стакло, а не ме штета.", "Τὴ γλῶσσα μοῦ ἔδωσαν ἑλληνικὴ", "ᚷᛖᚻᚹᛦᛚᚳᚢᛗ" };
      ...
      for (int i = 0; i < names.length; i++){
         ...
         System.out.println("Wrote " + names[i] + " to file.");
      }
